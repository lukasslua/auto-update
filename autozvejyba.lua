...
local update_url = 'https://raw.githubusercontent.com/lukasslua/auto-update/main/update.ini' -- Путь к ini файлу. Позже нам понадобиться.
local update_path = getWorkingDirectory() .. "/update.ini"

local script_url = 'https://github.com/lukasslua/auto-update/blob/main/autozvejyba.luac?raw=true' -- Путь скрипту.
